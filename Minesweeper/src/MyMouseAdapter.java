...
public class MyMouseAdapter extends MouseAdapter {
	...
	public boolean getState(){ // State Getter
		return state;
	}
	MyPanel myPanel = new MyPanel();
	
	ArrayList<MineCoordinates> mines = new MineCoordinates().coordinates(); // Arraylist mines


//	public void minesCloseBy(ArrayList<MineCoordinates> mines){



		//		
		//
		//		return	(mines.get(index).getX() == myPanel.getGridX(x, y) && mines.get(index).getY() == myPanel.mouseDownGridY);
		//	}
